...
import { CompletionList, DidChangeWatchedFilesParams, DocumentFormattingParams, DocumentLink, DocumentLinkParams, DocumentOnTypeFormattingParams, DocumentSymbolParams, FoldingRangeParams, IConnection, TextDocumentPositionParams } from 'vscode-languageserver';
...
export declare class LanguageHandlers {
    ...
    constructor(connection: IConnection, languageService: LanguageService, yamlSettings: SettingsState, validationHandler: ValidationHandler);
