...
describe('Auto Completion Tests', () => {
    ...
    describe('YAML Completion Tests', function () {
        ...
        describe('Array completion', () => {
            it('Simple array object completion with "-" without any item', () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('Simple array object completion without "-" after array item', () => __awaiter(this, void 0, void 0, function* () {
                const schema = require(path.join(__dirname, './fixtures/testArrayCompletionSchema.json'));
                languageService.addSchema(testHelper_1.SCHEMA_ID, schema);
                const content = 'test_simpleArrayObject:\n  - obj1:\n      name: 1\n  ';
                const completion = parseSetup(content, content.length);
            ...
            it('Simple array object completion with "-" after array item', () => __awaiter(this, void 0, void 0, function* () {
                const schema = require(path.join(__dirname, './fixtures/testArrayCompletionSchema.json'));
                languageService.addSchema(testHelper_1.SCHEMA_ID, schema);
                const content = 'test_simpleArrayObject:\n  - obj1:\n      name: 1\n  -';
                const completion = parseSetup(content, content.length);
            ...
            it('Array anyOf two objects completion with "- " without any item', () => __awaiter(this, void 0, void 0, function* () {
                const schema = require(path.join(__dirname, './fixtures/testArrayCompletionSchema.json'));
                languageService.addSchema(testHelper_1.SCHEMA_ID, schema);
            ...
            it('Array anyOf two objects completion without "-" after array item', () => __awaiter(this, void 0, void 0, function* () {
                const schema = require(path.join(__dirname, './fixtures/testArrayCompletionSchema.json'));
                languageService.addSchema(testHelper_1.SCHEMA_ID, schema);
                const content = 'test_array_anyOf_2objects:\n  - obj1:\n      name: 1\n  ';
                const completion = parseSetup(content, content.length);
            ...
            it('Array anyOf two objects completion with "-" after array item', () => __awaiter(this, void 0, void 0, function* () {
                const schema = require(path.join(__dirname, './fixtures/testArrayCompletionSchema.json'));
                languageService.addSchema(testHelper_1.SCHEMA_ID, schema);
                const content = 'test_array_anyOf_2objects:\n  - obj1:\n      name: 1\n  -';
                const completion = parseSetup(content, content.length);
